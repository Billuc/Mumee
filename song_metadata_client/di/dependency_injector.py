...
from song_metadata_client.classes import SpotifyOptions, SpotifyMetadataClient, YTMusicMetadataClient
...
def add_song_metadata_client(services: DependencyCollection) -> DependencyCollection:
    ...
    services.register_pipeline(BaseMetadataClient)\
        .add(SpotifyTrackHandler)\
        .add(SpotifyPlaylistHandler)\
        .add(YTMusicTrackHandler)\
        .add(YTMusicPlaylistHandler)\
        .add(SpotifySearchHandler)\
        .add(YTMusicSearchHandler)\
        .register()
